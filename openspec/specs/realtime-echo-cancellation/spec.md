# Realtime echo cancellation Specification

## Purpose

Define the explicit render-reference capture, bounded dual-input synchronization, frozen-default echo-cancellation processing, safe degradation, diagnostics and end-to-end validation requirements for the real-time `MiniAEC Microphone` path.
