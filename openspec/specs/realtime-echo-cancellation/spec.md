...
Define explicit physical render-reference capture, bounded dual-input synchronization, frozen-default echo cancellation, safe degradation, diagnostics and end-to-end validation through a paired VB-CABLE output route.
