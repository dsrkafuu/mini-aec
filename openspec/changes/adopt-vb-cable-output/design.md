...
4. Runtime acceptance phase: after separate user authorization and manual VB-CABLE installation, validate bypass, default AEC, Recorder/meeting-client consumption, stop/restart, invalidation and the 30-minute stability gate without modifying driver lifecycle or default roles.
